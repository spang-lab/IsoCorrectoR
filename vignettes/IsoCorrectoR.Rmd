...
###IsoCorrectoR version with graphical user interface (IsoCorrectoRGUI)

Start an R session, e.g. by starting RStudio. If you want to __use IsoCorrectoR with a graphical user interface__, type __BioCLite("IsoCorrectoRGUI")__ into your R console to install the package __IsoCorrectoRGUI__. Then type __library(IsoCorrectoRGUI)__ to load the package. If you install IsoCorrectoRGUI, the base version of IsoCorrecoR with the console interface will be installed, too, so you can use it as well.

###Base version of IsoCorrectoR with console interface (IsoCorrectoR)

If you do not need a graphical user interface and only want to __install the base version of IsoCorrectoR (console interface only)__, start an R session, e.g. by starting RStudio. Then type __BioCLite("IsoCorrectoR")__ into the R console to install the package __IsoCorrectoR__. Then type __library(IsoCorrectoR)__ to load the package.
